...
mixin _$CategoryState {
 ...
 CategoryStatus get status; List<Category> get categories; String? get errorMessage;
...
@useResult
$Res call({
 CategoryStatus status, List<Category> categories, String? errorMessage
});
...
as List<Category>,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CategoryStatus status,  List<Category> categories,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CategoryStatus status,  List<Category> categories,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _CategoryState():
return $default(_that.status,_that.categories,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CategoryStatus status,  List<Category> categories,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
return $default(_that.status,_that.categories,_that.errorMessage);case _:
  return null;
...
class _CategoryState implements CategoryState {
  const _CategoryState({this.status = CategoryStatus.initial, final  List<Category> categories = const [], this.errorMessage}): _categories = categories;
