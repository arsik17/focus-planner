...
mixin _$TaskListState {
 ...
 TaskListStatus get status; List<Task> get tasks; String? get selectedCategoryId; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(tasks),selectedCategoryId,errorMessage);

@override
String toString() {
  return 'TaskListState(status: $status, tasks: $tasks, selectedCategoryId: $selectedCategoryId, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 TaskListStatus status, List<Task> tasks, String? selectedCategoryId, String? errorMessage
});
...
/// Create a copy of TaskListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? tasks = null,Object? selectedCategoryId = freezed,Object? errorMessage = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as TaskListStatus,tasks: null == tasks ? _self.tasks : tasks // ignore: cast_nullable_to_non_nullable
as List<Task>,selectedCategoryId: freezed == selectedCategoryId ? _self.selectedCategoryId : selectedCategoryId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TaskListStatus status,  List<Task> tasks,  String? selectedCategoryId,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskListState() when $default != null:
return $default(_that.status,_that.tasks,_that.selectedCategoryId,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TaskListStatus status,  List<Task> tasks,  String? selectedCategoryId,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _TaskListState():
return $default(_that.status,_that.tasks,_that.selectedCategoryId,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TaskListStatus status,  List<Task> tasks,  String? selectedCategoryId,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _TaskListState() when $default != null:
return $default(_that.status,_that.tasks,_that.selectedCategoryId,_that.errorMessage);case _:
  return null;
...
class _TaskListState implements TaskListState {
  const _TaskListState({this.status = TaskListStatus.initial, final  List<Task> tasks = const [], this.selectedCategoryId, this.errorMessage}): _tasks = tasks;
  

@override@JsonKey() final  TaskListStatus status;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_tasks),selectedCategoryId,errorMessage);
...
/// Create a copy of TaskListState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? tasks = null,Object? selectedCategoryId = freezed,Object? errorMessage = freezed,}) {
  return _then(_TaskListState(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as TaskListStatus,tasks: null == tasks ? _self._tasks : tasks // ignore: cast_nullable_to_non_nullable
as List<Task>,selectedCategoryId: freezed == selectedCategoryId ? _self.selectedCategoryId : selectedCategoryId // ignore: cast_nullable_to_non_nullable
as String?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
